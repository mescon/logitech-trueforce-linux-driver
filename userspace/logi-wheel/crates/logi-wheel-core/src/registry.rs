...
pub const REGISTRY: &[SettingSpec] = &[
    ...
    SettingSpec { attr: "wheel_led_direction", label: "Direction", help: "Which way the lights animate: left to right, right to left, from the centre outward, or from the edges inward. Pick whichever fill you prefer to watch.", category: Leds, kind: Kind::Enum(&["R to L", "L to R", "inside-out", "outside-in"]), access: ReadWrite, mode_req: Any },
