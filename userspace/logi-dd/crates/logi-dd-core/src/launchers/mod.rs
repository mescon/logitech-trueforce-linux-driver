//! Unified game-discovery data model. Each launcher backend (Steam here;
//! Lutris and Heroic follow) scans its own install for games and reports
//! them as [`DiscoveredGame`]s; an aggregator merges the backends' results
//! for the Setup pages, which offer a shim install for any Wine game.
